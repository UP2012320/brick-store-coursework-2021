...
export default function createShopCard(props) {
  props.key ??= nameof(createShopCard);
  const cardContainer = createElement('div', undefined, browseStyles.shopCardContainer);
  ...
  const idStockRow = createElement('div', undefined, browseStyles.shopCardRowId);
  ...
  const actionsRow = createElement('div', undefined, browseStyles.shopCardRowActions);
