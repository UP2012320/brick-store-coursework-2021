...
export default function createDropdownSingleSelectBody(props) {
  ...
  for (const option of props.dropDownOptions) {
    ...
    const dropDownCheck = createElement('i',
      undefined,
      option.value === selected.value ? dropDownStyles.biCircleFill : dropDownStyles.biCircle
    );
