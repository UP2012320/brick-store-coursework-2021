...
import createDropdownSingleSelectBody
  from 'Scripts/components/dropdown/dropdownSingleSelectBody/dropdownSingleSelectBody';
...
export default function createFilterBar(props) {
  ...
  const container = createElement('section', undefined, filterBarStyles.filterBarContainer);
  ...
  const LeftSectionContainer = createElement('section', undefined, filterBarStyles.filterBarSectionContainer);
  const rightSectionContainer = createElement('section', undefined, filterBarStyles.filterBarSectionContainerRight);
  ...
  const searchButton = createElement('div', {
    onclick: () => {
      const searchInput = document.querySelector(`.${filterBarStyles.filterBarSearchItem}`);
      if (searchInput) {
